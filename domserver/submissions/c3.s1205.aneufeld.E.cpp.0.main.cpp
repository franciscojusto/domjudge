...
int main(int argc, char** argv)
{
    ...
    while (1)
    {
        ...
        else if (in == S)
        {
            ...
            bool space = false;
            for (int i = 0; i < p->parents->numChildren; i++)
            {
                P * sibling = p->parents->children[i];
        ...
        else if (in == PA)
        {
            ...
            P * p = P::find(child);
            cout << p->getFather()->name << " " << p->getMother()->name << endl;
        }
        else if (in == GP)
        {
            string child = "";
            ...
            bool s = father->parents != NULL && mother->parents != NULL;
