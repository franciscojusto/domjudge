	...
	public static void main(String[] arg) {
		...
		while (input.hasNextLine()) {
			...
			if (rule.contains("NEW CHILD ")) {
				...
				System.out.print(findSibling(sibling, parent, split));
				...
				System.out.print(findGrandChildren(sibling, split));
				...
				System.out.print(findGrandParent(sibling, parent, split));
				...
				System.out.print(findParent(sibling, parent, split));
				...
				System.out.print(findChild(sibling, parent, split));
			}
		}
	}
