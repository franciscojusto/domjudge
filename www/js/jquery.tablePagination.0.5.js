 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
        var htmlBuffer = [];
        htmlBuffer.push("<div id='tablePagination' style='text-align: center; border-top: solid 1px #646875; padding-top: 5px; padding-bottom: 5px;'><br>");
        ...
        htmlBuffer.push("<p><span id='tablePagination_perPage'>");
        htmlBuffer.push("<select  onchange='resetCurrentPage(1)' id='tablePagination_rowsPerPage'><option value='5'>5</option></select>");
        htmlBuffer.push("per page");
        htmlBuffer.push("</span></p>");
        htmlBuffer.push("</div>");
