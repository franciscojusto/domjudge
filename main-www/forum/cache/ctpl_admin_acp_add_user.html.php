...
//-->
	...
	<form id="register" method="post" autocomplete="off" action="<?php echo (isset($this->_rootref['U_ACTION'])) ? $this->_rootref['U_ACTION'] : ''; ?>">
...
<fieldset>
	...
	<dl>
		<dt><label for="group"><?php echo ((isset($this->_rootref['L_GROUPS'])) ? $this->_rootref['L_GROUPS'] : ((isset($user->lang['GROUPS'])) ? $user->lang['GROUPS'] : '{ GROUPS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_GROUP_ADD'])) ? $this->_rootref['L_GROUP_ADD'] : ((isset($user->lang['GROUP_ADD'])) ? $user->lang['GROUP_ADD'] : '{ GROUP_ADD }')); ?></span></dt>
		<dd><?php echo (isset($this->_rootref['S_GROUP_OPTIONS'])) ? $this->_rootref['S_GROUP_OPTIONS'] : ''; ?></dd>
	</dl>	
