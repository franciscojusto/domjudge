...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<div id="forum_cat_options">
		...
		<dl>
			<dt><label for="cat_display_subforum_list"><?php echo ((isset($this->_rootref['L_LIST_SUBFORUMS'])) ? $this->_rootref['L_LIST_SUBFORUMS'] : ((isset($user->lang['LIST_SUBFORUMS'])) ? $user->lang['LIST_SUBFORUMS'] : '{ LIST_SUBFORUMS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_LIST_SUBFORUMS_EXPLAIN'])) ? $this->_rootref['L_LIST_SUBFORUMS_EXPLAIN'] : ((isset($user->lang['LIST_SUBFORUMS_EXPLAIN'])) ? $user->lang['LIST_SUBFORUMS_EXPLAIN'] : '{ LIST_SUBFORUMS_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="cat_display_subforum_list" value="1"<?php if ($this->_rootref['S_DISPLAY_SUBFORUM_LIST']) {  ?> id="cat_display_subforum_list" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="cat_display_subforum_list" value="0"<?php if (! $this->_rootref['S_DISPLAY_SUBFORUM_LIST']) {  ?> id="cat_display_subforum_list" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>

		<dl>
			<dt><label for="cat_display_on_index"><?php echo ((isset($this->_rootref['L_LIST_INDEX'])) ? $this->_rootref['L_LIST_INDEX'] : ((isset($user->lang['LIST_INDEX'])) ? $user->lang['LIST_INDEX'] : '{ LIST_INDEX }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_LIST_INDEX_EXPLAIN'])) ? $this->_rootref['L_LIST_INDEX_EXPLAIN'] : ((isset($user->lang['LIST_INDEX_EXPLAIN'])) ? $user->lang['LIST_INDEX_EXPLAIN'] : '{ LIST_INDEX_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="cat_display_on_index" value="1"<?php if ($this->_rootref['S_DISPLAY_ON_INDEX']) {  ?> id="cat_display_on_index" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="cat_display_on_index" value="0"<?php if (! $this->_rootref['S_DISPLAY_ON_INDEX']) {  ?> id="cat_display_on_index" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
